...
export const MODULES_DATA: Module[] = [
  {
    ...
    titleBn: 'মডিউল ১: Home Row (ভিত্তি স্থাপন)',
    subtitleEn: 'Master finger placement on A S D F and J K L ;',
    subtitleBn: 'A S D F এবং J K L ; তে আঙুলের নিখুঁত অবস্থান',
    icon: 'Home',
    color: 'emerald',
    lessons: [
      {
        ...
        keysIntroduced: ['f', 'j', ' '],
        targetText: 'f f f j j j f j f j j f f j j f f f j j f j f j',
        targetAccuracy: 95,
        xpReward: 50,
      },
      {
        ...
        keysIntroduced: ['d', 'k'],
        targetText: 'd d d k k k d k d k f d j k d f k j d k f j d f k j',
        targetAccuracy: 95,
        xpReward: 60,
      },
      {
        ...
        keysIntroduced: ['s', 'l'],
        targetText: 's s s l l l s l s l s d l k f s j l s l d k f j s l',
        targetAccuracy: 95,
        xpReward: 70,
      },
      {
        ...
        keysIntroduced: ['a', ';'],
        targetText: 'a a a ; ; ; a ; a ; a s d f j k l ; a l s k d j f ; a s d f',
        targetAccuracy: 95,
        xpReward: 80,
      },
      {
        ...
        targetText: 'asdf jkl; fdsa ;lkj asdf ;lkj fjdk sla; fads klas jfad',
        targetAccuracy: 95,
        xpReward: 90,
      },
      {
